...
public class TopFreeAppsAdapter extends RecyclerView.Adapter<TopFreeAppsAdapter.MyViewHolder> {
    ...
    @NonNull
    @Override
    public TopFreeAppsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TopFreeAppsAdapter.MyViewHolder holder, int position) {
        Glide.with(mContext)
